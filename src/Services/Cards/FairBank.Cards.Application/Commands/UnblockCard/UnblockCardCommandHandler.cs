...
public sealed class UnblockCardCommandHandler(
    ICardRepository cardRepository,
    IUnitOfWork unitOfWork) : IRequestHandler<UnblockCardCommand, CardResponse>
{
    public async Task<CardResponse> Handle(UnblockCardCommand request, CancellationToken ct)
    {

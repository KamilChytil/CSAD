...
public sealed class CancelCardCommandHandler(
    ...
    IUnitOfWork unitOfWork) : IRequestHandler<CancelCardCommand, CardResponse>
{
    public async Task<CardResponse> Handle(CancelCardCommand request, CancellationToken ct)
    {
